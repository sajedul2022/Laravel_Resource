                        ...
                        <div class="row pb-5">
                            <div class="col-lg-6">
                                ...
                                <div class="product-gallery me-xl-1 me-xxl-5">
                                    ...
                                    <img src="{{'product_photos/'.$product->product_image}}" class="rounded w-100" alt="">

                                </div><!-- .product-gallery -->
                            </div><!-- .col -->
                            <div class="col-lg-6">
                                <div class="product-info mt-5 me-xxl-5">
                                    <h4 class="product-price text-primary">${{ $product->product_price }} <small
                                            class="text-muted fs-14px">${{ $product->product_price }}</small></h4>
                                        ...
                                        <ul class="custom-control-group">
                                            <li>
                                                <div class="custom-control color-control">
                                                    <input type="radio" class="custom-control-input" id="productColor1"
                        ...
                        <div class="row g-gs flex-lg-row-reverse pt-5">
                            ...
                            <div class="col-lg-7">
                                <div class="product-details entry me-xxl-3">
                                    ...
                                    <p>Unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam
                                    ...
                                    <p>I must explain to you how all this mistaken idea of denouncing pleasure and praising
                                        ...
                                        actual teachings. Unde omnis iste natus error sit voluptatem accusantium doloremque
                                        laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi
                                        architecto beatae.</p>
                                </div>
                            </div><!-- .col -->
                    ...
                    <div class="col">
                        <div class="card card-bordered product-card">
                            ...
                            <div class="card-inner text-center">
                                ...
                                <h5 class="product-title"><a href="html/product-details.html">White Vintage telephone</a>
                                </h5>
                                <div class="product-price text-primary h5"><small
