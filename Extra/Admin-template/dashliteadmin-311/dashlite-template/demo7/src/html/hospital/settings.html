                                                    ...
                                                    <form action="#" class="form-settings">
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="site-name">Hospital Name</label>
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" class="form-control" id="site-email" value="Softnio Street 3">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 align-center">
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="form-note">Copyright information of your hospital.</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu">
                                                            <li><a class="active" href="html/hospital/settings.html"><em class="icon ni ni-user-fill-c"></em><span>General</span></a></li>
                                                            <li><a href="html/hospital/settings-member.html"><em class="icon ni ni-bell-fill"></em><span>Users</span></a></li>
