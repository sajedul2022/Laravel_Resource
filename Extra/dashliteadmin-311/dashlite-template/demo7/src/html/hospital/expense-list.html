...
<head>
    ...
    <!-- Page Title  -->
    <title>Expense List | DashLite Admin Template</title>
    <!-- StyleSheets  -->
...
<body class="nk-body ui-rounder npc-default has-sidebar ">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt">
                                                            <a data-bs-toggle="modal" class="btn btn-primary" href="#addExpense"><em class="icon ni ni-plus"></em><span>Add Expense</span></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div><!-- .toggle-wrap -->
                                                    ...
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            <div class="card-title">
                                                                <h6 class="title">Electricity Charges</h6>
                                                            </div>
                                                        </div>
                                                        <div class="data">
                                                            <div class="data-group">
                                                                <div class="amount">$7,955</div>
                                                                <div class="nk-ecwg6-ck">
                                                                    <canvas class="ecommerce-line-chart-s3" id="electricity"></canvas>
                                                                </div>
                                                            </div>
                                                            <div class="info"><span class="change down text-danger"><em class="icon ni ni-arrow-long-down"></em>2.23%</span><span> vs. last month</span></div>
                                                        </div>
                                                    </div><!-- .card-inner -->
                                                </div><!-- .nk-ecwg -->
                                            </div><!-- .card -->
                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            <div class="card-title">
                                                                <h6 class="title">Equipements</h6>
                                                            </div>
                                                        </div>
                                                        <div class="data">
                                                            <div class="data-group">
                                                                <div class="amount">$8,830</div>
                                                                <div class="nk-ecwg6-ck">
                                                                    <canvas class="ecommerce-line-chart-s3" id="equipements"></canvas>
                                                                </div>
                                                            </div>
                                                            <div class="info"><span class="change up text-danger"><em class="icon ni ni-arrow-long-up"></em>1.12%</span><span> vs. last month</span></div>
                                                        </div>
                                                    </div><!-- .card-inner -->
                                                </div><!-- .nk-ecwg -->
                                            </div><!-- .card -->
                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="data">
                                                            <div class="data-group">
                                                                <div class="amount">$8,974</div>
                                                                <div class="nk-ecwg6-ck">
                                                                    <canvas class="ecommerce-line-chart-s3" id="maintenance"></canvas>
                                                                </div>
                                                            </div>
                                                            <div class="info"><span class="change down text-danger"><em class="icon ni ni-arrow-long-down"></em>1.36%</span><span> vs. last month</span></div>
                                                        </div>
                                                    </div><!-- .card-inner -->
                                                </div><!-- .nk-ecwg -->
                                            </div><!-- .card -->
                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            <div class="card-title">
                                                                <h6 class="title">Rents</h6>
                                                            </div>
                                                        </div>
                                                        <div class="data">
                                                            <div class="data-group">
                                                                <div class="amount">$30,485</div>
                                                                <div class="nk-ecwg6-ck">
                                                                    <canvas class="ecommerce-line-chart-s3" id="rents"></canvas>
                                                                </div>
                                                            </div>
                                                            <div class="info"><span class="change up text-primary"><em class="icon ni ni-arrow-long-up"></em>1.34%</span><span> vs. last month</span></div>
                                                        </div>
                                                    </div><!-- .card-inner -->
                                                </div><!-- .nk-ecwg -->
                                            </div><!-- .card -->
                                    ...
                                    <div class="card card-bordered card-stretch">
                                        <div class="card-inner-group">
                                            <div class="card-inner position-relative card-tools-toggle">
                                                <div class="card-title-group">
                                                    <div class="card-title">
                                                        <h5 class="title">Expenses List</h5>
                                                    </div>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list nk-tb-ulist is-compact">
                                                    <div class="nk-tb-item nk-tb-head bg-lighter">
                                                        ...
                                                        <div class="nk-tb-col tb-col-md"><span class="sub-text">Expense Head</span></div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="html/hospital/invoice-details.html">#746F5K2</a></span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>Hospital Rent</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>23 Jan 2019</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span>Building rent</span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">$2300.00</span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="html/hospital/invoice-details.html">#546H74W</a></span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>EKG/ECG Machines</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">$3020.00</span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="html/hospital/invoice-details.html">#87X6A44</a></span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">$560.00</span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="html/hospital/invoice-details.html">#986G531</a></span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">$5540.00</span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="html/hospital/invoice-details.html">#326T4M9</a></span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>Hospital Camp</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                            <span>21 Jan 2019</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">$3350.99</span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">$5550.00</span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span>Pathology lab equipment</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">$8000.00</span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="html/hospital/invoice-details.html">#69X6445</a></span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span>Xray</span>
                                                        </div>
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-amount">$7050.00</span>
                                                        </div>
                                                    </div><!-- .nk-tb-item -->
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col nk-tb-col-check">
                                                        ...
                                                        <div class="nk-tb-col tb-col-mb">
                                                            <span class="fw-medium"><a href="html/hospital/invoice-details.html">#4206469</a></span>
                                                        </div>
                                                        <div class="nk-tb-col">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-4">
                        <div class="row g-gs">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="expenseHead">Expense Head</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="expenseHead" placeholder="Expense Head">
                                    </div>
                                </div>
                            </div><!-- .col -->
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li>
                                        <a href="#" data-bs-dismiss="modal" class="btn btn-primary">Add Expense</a>
                                    </li>
                                    <li>
    ...
    <script src="./assets/js/charts/hospital-report.js?ver=3.1.1"></script>
</body>
