                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu">
                                                            <li><a href="html/hospital/settings.html"><em class="icon ni ni-user-fill-c"></em><span>General</span></a></li>
                                                            ...
                                                            <li><a class="active" href="html/hospital/settings-account-log.html"><em class="icon ni ni-activity-round-fill"></em><span>Account activity</span></a></li>
                                                        </ul>
                                                    </div><!-- .card-inner -->
